...
exports.startMockSimulation = void 0;
const ttsPipeline_1 = require("./ttsPipeline");
const startMockSimulation = (ws, analyzer, coach, targetDistance, targetPaceSeconds, strictness) => {
...
exports.startMockSimulation = startMockSimulation;
